...
export const FAQS = [
  ...
  {
    q: 'איך מתבצע התשלום?',
    a: 'לאחר סגירת ההזמנה מול המשכירה, התשלום מתבצע דרך האתר — בביט או בהעברה בנקאית. לאחר אישור ההנהלה שהתשלום התקבל, השמלה משוריינת לך לתאריך שבחרת ותישלח אלייך הודעת אישור במייל.',
  },
  {
