...
export const FAQS = [
  ...
  {
    q: 'איך מתבצע התשלום?',
    a: 'לאחר בחירת שמלה ותאריך, נשלחת בקשת שריון למשכירה. רק אחרי שהיא מאשרת שהשמלה פנויה ומתאימה — משלמים בביט או בהעברה בנקאית. לאחר אישור ההנהלה שהתשלום התקבל, השמלה משוריינת לך לתאריך שבחרת.',
  },
  {
...
/** כפתור בקשת אישור סופי מהמשכירה — רק אחרי תיאום ומדידה */
export const FINAL_OWNER_APPROVAL_BUTTON_LABEL = 'בקשת אישור סופי מהמשכירה';

export const FINAL_OWNER_APPROVAL_HINT =
  'שימי לב: שלב זה מיועד לאישור סופי מהמשכירה — רק לאחר שתיאמתן, מדדתן את השמלה ווידאתן שהיא מתאימה לך.';

export const FITTING_CONFIRMATION_TITLE = 'לפני שליחת הבקשה';

export const FITTING_CONFIRMATION_BODY =
  'בקשת האישור הסופי מיועדת רק לאחר שתיאמתן עם המשכירה, מדדתן את השמלה ווידאתן שהיא מתאימה לך לתאריך האירוע.';
