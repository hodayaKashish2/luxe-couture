    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fbf8f0] via-[#f3ebd6] to-[#e8dcbd] flex items-center justify-center p-4" dir="rtl">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} noValidate className="bg-white/95 rounded-2xl border-2 border-[#e6c687] shadow-xl p-6 space-y-3">
          <div>
            <input placeholder="שם משתמש *" value={form.username} onChange={(e) => setForm({ ...form, username: e.target.value })} className="w-full p-2.5 border-2 border-[#decfa8] rounded-xl text-sm text-[#2c261a] placeholder:text-[#9a7b4f] bg-white focus:border-[#d4af37] focus:outline-none" dir="ltr" />
            <p className="text-[10px] text-[#9a7b4f] mt-1">שם משתמש ייחודי — אם תפוס תופיע הודעה</p>
          </div>
          <input type="password" placeholder="סיסמה (6+ תווים) *" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="w-full p-2.5 border-2 border-[#decfa8] rounded-xl text-sm text-[#2c261a] placeholder:text-[#9a7b4f] bg-white focus:border-[#d4af37] focus:outline-none" dir="ltr" />
          ...
          <input type="tel" placeholder="טלפון (053...) *" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} className="w-full p-2.5 border-2 border-[#decfa8] rounded-xl text-sm text-[#2c261a] placeholder:text-[#9a7b4f] bg-white focus:border-[#d4af37] focus:outline-none" dir="ltr" />
