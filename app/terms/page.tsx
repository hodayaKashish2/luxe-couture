    ...
    <ContentPage title="תקנון האתר" subtitle={`תנאי שימוש ב-${SITE_NAME}`}>
      ...
      <section className="bg-gradient-to-l from-[#fffdf9] to-[#f4ebd4] border border-[#e6c687] rounded-xl p-5">
        <h2 className="font-[family-name:var(--font-luxury)] text-lg text-[#3d2f24] mb-2">
          2. עמלת פלטפורמה ({COMMISSION_PERCENT}%)
        </h2>
      ...
      <section>
        <h2 className="font-bold text-[#3d2f24] mb-2">3. עבודה דרך האתר בלבד</h2>
      ...
      <section>
        <h2 className="font-bold text-[#3d2f24] mb-2">4. תשלום</h2>
        <p className="text-xs leading-relaxed">
      ...
      <section>
        <h2 className="font-bold text-[#3d2f24] mb-2">6. פרסום שמלה</h2>
        <p className="text-xs leading-relaxed">
      ...
      <section>
        <h2 className="font-bold text-[#3d2f24] mb-2">7. ביטולים</h2>
        <p className="text-xs leading-relaxed">
