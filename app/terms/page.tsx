    ...
    <ContentPage title="תקנון האתר" subtitle={`תנאי שימוש ב-${SITE_NAME} — נא לקרוא בעיון לפני השימוש`}>
      ...
      <HighlightSection title="3. ויתור אחריות והגבלת חבות">
        ...
        <ul className="text-xs space-y-1.5 list-disc pr-5 mb-3">
          ...
          <li>פעולה או מחדל של ספקי צד שלישי (לרבות אחסון ענן, דוא״ל)</li>
        </ul>
        <p className="text-xs leading-relaxed mb-3">
      ...
      <section>
        ...
        <p className="text-xs leading-relaxed">
          התשלום מתבצע דרך האתר בשתי דרכים לבחירה: ביט או העברה בנקאית.
          מפעילת האתר אינה בנק, אינה מוסד פיננסי ואינה אחראית לתקלות סליקה, חיובים כפולים, ביטולי
          כרטיס או מחלוקות סביב החיוב — אלה יטופלו מול ספק הסליקה והצדדים לעסקה. פיקדון — לפי מה
          שמצוין בכרטיס השמלה, באחריות הצדדים בלבד.
        </p>
      </section>
