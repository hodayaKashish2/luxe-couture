...
const steps = [
  ...
  },
  {
    ...
    text: 'מסננות לפי מידה, מחיר וסוג אירוע. הקטלוג מציג שמלות מומלצות לפי דירוגים, חדשות וחשיפה.',
  },
  {
    title: 'הזמנה ותשלום',
    text: 'בוחרות תאריך, שולחות בקשת שריון למשכירה, ומשלמות בביט או בהעברה בנקאית רק אחרי אישור — פשוט ובטוח.',
  },
  {
    title: 'אחרי האירוע',
